...
```sh
git <git clone https://github.com/teacher-fiit/GitCheatSheet.git>
```
...
```sh
git <add index.html>
git <commit -a -m "Изменение связанное с index">
```
...
```sh
git <add style.css>
git <commit -a -m "Изменение сязанное с style">
```
...
```sh
git <Не пригодилось>
git <git push https://github.com/Hanennni/repository-for-learning.git>
```
